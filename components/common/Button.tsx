...
const baseClasses = 'font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-light-bg dark:focus:ring-offset-dark-bg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center transform hover:-translate-y-0.5 active:translate-y-0';

const variantClasses: { [key in ButtonVariant]: string } = {
  primary: 'bg-gradient-primary text-white hover:opacity-90 focus:ring-primary shadow-lg hover:shadow-xl hover:shadow-primary/30',
